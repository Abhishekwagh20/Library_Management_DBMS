...
<!--  Free CSS Template from www.TemplateMo.com  -->
    ...
    <div id="templatemo_content">
        ...
        <%if(msg!=null){%>
			...
			<h3><font color="red">Welcome </h3><%=(String)session.getAttribute("username")%></font><br><br><br>
            <a href="bookreq.jsp">New Book Request</a>
            </p>
            <h2><font color="red">Search for Book By Book Name</font></h2>
			<form name="search" action="searchbyname.jsp" method="post" onSubmit="return validate()">
			<table>
	...
	<tr colspan="2" ><td align="center"><input type="submit" value="Search"></td><td><center><input TYPE="RESET" VALUE="Reset"></center></td></tr>
			 ...
			 <h2><font color="red">Search for Book By Author Name</font></h2>
			<form name="search" action="searchbyaname.jsp" method="post" onSubmit="return validate()">
			<table>
			<tr ><td  align="right"> Author Name&nbsp;&nbsp;&nbsp;:</td>
    <td class="s1"><input  type="text" name="author" ></td></tr>
	<tr ><td height="10"></td>
    </tr>
	<tr colspan="2" ><td align="center"><input type="submit" value="Search"></td><td><center><input TYPE="RESET" VALUE="Reset"></center></td></tr>
</table>
        ...
        <div id="content_right">
            ...
            <div class="title">View Notifcations</div>
            <a href="ViewNotifications.jsp">View Notifcations</a>            
            <div class="cleaner" style="height: 40px;">&nbsp;</div>
