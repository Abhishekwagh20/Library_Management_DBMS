    ...
    <div id="templatemo_content">
	   ...
	   <%if(msg!=null){%>
        	...
        	<table cellspacing="20" border="2" width="600px;">
			 <tr><th><font color="red">Book  ID</font></th><th><font color="red">Book  Name</font></th><th><font color="red">Author</font></th><th><font color="red">Edition</font></th><th><font color="red">NO.Of.Copies</font></th><th><font color="red">Published Date</font></th><th><font color="red">Reserve</font></th></tr>
			 <%while(rs.next())
			{
				%>
			 <tr>
