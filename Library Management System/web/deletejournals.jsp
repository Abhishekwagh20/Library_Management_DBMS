    ...
    <div id="templatemo_content">
       ...
       <div id="content_left">
        	...
        	<table cellspacing="20" border="2" width="600px;">
			 <tr><th><font color="red">Journal Name</font></th><th><font color="red">Author</font></th><th><font color="red">Published Date</font></th><th><font color="red">NO.Of.Copies</font></th><th><font color="red">Delete</font></th></tr>
			 <%while(rs.next())
			{%>
			 <tr>
			 ...
			 <td><a href="jdelete.jsp?jname=<%=rs.getString(1)%>&author=<%=rs.getString(2)%>&noc=<%=rs.getString(4)%>"><font color="green">Delete</font></td>
			 </tr>
			 <%}
	}
			catch(Exception e)
