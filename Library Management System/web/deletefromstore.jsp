...
<!--  Free CSS Template from www.TemplateMo.com  -->
    ...
    <div id="templatemo_content">
        ...
        <div id="content_left">
        	...
        	<div class="title">Delete From Store</div>
			<br><br>
           <a href="deletebooks.jsp">Delete Books</a><br><br><br>
		    <a href="deletejournals.jsp">Delete Journals</a><br><br><br>

			 <a href="deletemagazine.jsp">Delete Magazines</a>
