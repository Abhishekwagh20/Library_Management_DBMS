...
<%
	...
	ResultSet rs=st.executeQuery("select * from book where author='"+author+"'");
%>
    ...
    <div id="templatemo_content">
	   ...
	   <%if(msg!=null){%>
        	...
        	<table cellspacing="20" border="2" width="600px;">
			 <tr><th><font color="red">Book  Name</font></th><th><font color="red">Author</font></th><th><font color="red">Edition</font></th><th><font color="red">NO.Of.Copies</font></th><th><font color="red">Published Date</font></th><th><font color="red">Reserve</font></th></tr>
			 <%while(rs.next())
			{
				%>
			 <tr>
			 ...
			 <td><a href="reserve.jsp?bname=<%=rs.getString(1)%>&author=<%=rs.getString(2)%>&edition=<%=rs.getString(3)%>&noc=<%=rs.getString(4)%>&pubdate=<%=rs.getString(5)%>"><font color="green">Reserve Book</font></td>
			 </tr>
			 <%}
	}
			catch(Exception e)
