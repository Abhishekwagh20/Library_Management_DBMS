...
<%
	...
	ResultSet rs=st.executeQuery("select * from reserve where status='"+status+"'");
%>
    ...
    <div id="templatemo_content">
       ...
       <div id="content_left">
        	...
        	<table cellspacing="20" border="2" width="600px;">
			 <tr><th><font color="red">Book  Name</font></th><th><font color="red">Author</font></th><th><font color="red">Edition</font></th><th><font color="red">NO.Of.Copies</font></th><th><font color="red">Published Date</font></th><th><font color="red">Roll No</font></th></th><th><font color="red">Status</font></th><th><font color="red">Accept</font></th></tr>
			 <%while(rs.next())
			{%>
			 <tr>
			...
			<td> <a href="accept.jsp?bname=<%=rs.getString(1)%>&author=<%=rs.getString(2)%>&status=<%=rs.getString(7)%>"><font color="green">Request Accept</font></a></td>
			 </tr>
			 <%}
	}
			catch(Exception e)
